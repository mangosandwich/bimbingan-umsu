...
export default function StudentSidebarNav({
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-3xl p-6 shadow-sm space-y-6 text-left h-fit w-full">
      ...
      <div className="flex items-center gap-3 pb-5 border-b border-gray-100 dark:border-zinc-800">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs text-muted-foreground font-mono truncate">NPM: {currentUser.npm || '2210000001'}</p>
      ...
      <div className="space-y-1.5">
        ...
        >
          <FilePlus className="w-4.5 h-4.5 shrink-0" />
          <span className="truncate">Pengajuan Judul</span>
        </Link>
        ...
        >
          ...
          {myProposal && !myThesis && (
            <span className="ml-auto text-[10px] bg-amber-500 text-white px-2 py-0.5 rounded-full font-bold animate-pulse shrink-0">
              Ditinjau
            </span>
          )}
          {myThesis && (
        ...
        >
          ...
          <span className="truncate">Log Bimbingan</span>
          {verifiedGuidancesCount > 0 && (
            <span className="ml-auto text-[10px] bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 px-2 py-0.5 rounded-full font-bold shrink-0">
        ...
        >
          ...
          <span className="truncate">Booking Jadwal</span>
          {activeBookingsCount > 0 && (
            <span className="ml-auto text-[10px] bg-purple-100 dark:bg-purple-950 text-purple-700 dark:text-purple-300 px-2 py-0.5 rounded-full font-bold shrink-0">
              {activeBookingsCount}
            </span>
          )}
        </Link>
